...
for filepath in filepaths:
    ...
    pdf.cell(w=30, h=8, txt="", border=1)
    pdf.cell(w=30, h=8, txt=str(sum_total), border=1, ln=1)

    pdf.set_font(family="Times", size=10, style="B")
    pdf.cell(w=30, h=8, txt=f"The total price is {sum_total}", ln=1)
    ...
    pdf.output(f"PFDS/{filename}.pdf")
